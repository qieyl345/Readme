...
|----------|-------------|
| 📖 **[How-to-use.md](How-to-use.md)** | Complete user guide for registration, login, browsing, booking, property management, and admin features |
| ⭐ **[Special_Features_Explanation.md](Special_Features_Explanation.md)** | Detailed technical explanation of 12 special features with code examples and diagrams |
| 🔌 **[API_Documentation.md](API_Documentation.md)** | Full REST API reference with all endpoints and request/response formats |
| 🚀 **[Deployment_Guide.md](Deployment_Guide.md)** | Step-by-step deployment guide for local, Railway, Vercel, and mobile builds |
