...
import { Settings, Bell, Shield, Moon, Sun, Globe, Key, Eye, EyeOff } from 'lucide-react'
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 border border-slate-200 rounded-lg">
                ...
                <button className="px-4 py-2 text-teal-600 hover:text-teal-700 font-medium transition-colors">
                  Change
                </button>
              </div>
